...
**确认决策**：MVP 使用受约束的四栏行动链工作区，固定为“证据文档 → 工具与技术 → 执行行动 → 干系人”。用户可以通过点击或拖动建立合法的一对多、多对一连接；系统禁止跨越语义错误的连接。卡片可在所属分栏内重新排序，但不提供无限画布、自由摆放、缩放和平移；同时提供键盘和点击式替代操作。

**行动链数量修正**：每个情景保留 5–7 个必要管理动作，但由于文档、工具、执行和干系人均使用独立卡，最小正确行动链允许 8–14 张卡，候选池调整为 18–24 张。最小性根据必要动作是否齐全及是否存在无效绕路判断，不按卡片绝对数量判断；选择多个必要证据或必要参与者不计为冗余。

**已确认情景一必要动作**：澄清家庭成员共享需求及安全边界；对照批准需求与范围确认基线外变更；评估范围、进度、成本、安全、质量和干系人影响；形成变更请求并提交 CCB；纳入 1.1 并保护 1.0 试点基线；更新关联记录并向试点车主说明替代流程和明确承诺。情景规则源文件为 `content/lab-cases/car-control/v1/scenario-plan.json`。

**已确认情景一最小正确卡**：D16/D21 两张证据卡；访谈、备选方案与综合影响分析、CCB 审查三张工具卡；创建变更请求、完成综合影响评估、纳入 1.1 并维持 1.0、更新记录并沟通替代流程四张执行卡；试点车主代表、产品负责人、技术负责人、DevOps/安全负责人、项目发起人五张干系人卡，共 14 张。用户本人是项目经理，不另设项目经理卡。D06/D14/D26 必须查看或通过仪表盘读取，但不要求拖入行动链。

**已确认情景一必要连接**：D21 连接访谈，D16/D21 连接综合影响分析与 CCB；访谈和综合影响分析连接影响评估，综合影响分析连接变更请求，CCB 连接纳入 1.1 决策，访谈连接记录与沟通；影响评估连接产品/技术/安全，变更请求连接产品/技术/安全/发起人，纳入 1.1 连接产品/发起人，记录与沟通连接试点车主代表/产品负责人。系统校验语义连接，不要求唯一排版。

**已确认情景一候选池**：共 22 张卡。D06/D14/D26、头脑风暴和市场发布负责人属于有帮助但非必要的可选项，前三项不扣正确性，后两项只增加少量管理负担；赶工、立即开发家庭共享功能、未经分析直接拒绝反馈属于有害干扰项，分别触发过早进度压缩、未受控范围执行和干系人预期失管后果。
...
**已确认情景二必要管理动作**：第 17 周同时触发供应商接口延期与核心车端接口工程师被临时抽调。最小正确集合必须覆盖七项必要管理动作：核实两项事实并登记关联问题；重算关键路径、接口依赖、资源日历及里程碑影响；与供应商联合排障并确定最小可交付接口和分阶段日期；启用 Mock 接口保持独立开发与测试并行；安排替补工程师和结构化交接且不压缩集成与质量门禁；更新进度预测、风险登记册、责任分配和供应商绩效记录；向项目发起人、产品负责人及受影响团队沟通“顺延一周、质量优先”方案并取得一致。七项动作分别使用 `S2-A1` 至 `S2-A7`，统一维护在 `content/lab-cases/car-control/v1/scenario-plan.json`。

**已确认情景二最小正确卡片**：最小行动链包含 14 张卡。文件卡为 D08 问题日志、D14 项目进度计划和 D26 风险登记册；工具与技术卡为进度网络与资源影响分析、供应商联合问题解决会议；执行卡为约定最小接口与分阶段交付、启用 Mock 并行开发测试、安排替补与结构化交接、更新记录并沟通顺延一周方案；干系人卡为车端接口供应商项目经理、技术负责人、测试工程师、产品负责人/业务分析师和项目发起人。D17 项目团队派工单、D24 资源日历和 D29 进度预测是必须查看的场景线索，但不要求拖入最小行动链。

**已确认情景二最小正确连接**：最小闭环包含 21 条有向连接。文件到工具共 4 条：D08→供应商联合问题解决会议、D14→进度网络与资源影响分析、D26→进度网络与资源影响分析、D26→供应商联合问题解决会议。工具到行动共 6 条：影响分析分别连接分阶段交付、Mock、替补交接和更新沟通，联合会议连接分阶段交付和更新沟通。行动到干系人共 11 条：分阶段交付连接供应商项目经理和技术负责人；Mock 及替补交接均连接技术负责人和测试工程师；更新沟通连接供应商项目经理、技术负责人、测试工程师、产品负责人和项目发起人。卡片选择正确但缺少必要连接时，只反馈相应闭环缺口，不判定为完整解决。
...
**已确认情景三必要管理动作**：第 25 周安全测试发现远程控制高危漏洞。最小正确集合必须覆盖七项必要管理动作：复核测试报告并复现漏洞，确认严重级别、影响范围和触发条件；登记安全问题并触发 R04/R10，立即冻结远程控制发布；综合评估范围、进度、成本、质量、安全及干系人影响；组织安全分诊与专家评审，制定修复、复测和残余风险处置方案；提交正式变更并完成 CCB 及上线阶段门决策，批准分阶段交付；通过功能开关和权限隔离确保只读/查看状态能力可独立安全上线；更新范围、需求追踪、风险、质量和发布资料，并向项目发起人、试点车主、运营及市场沟通预期。最优决策固定为“按期上线只读/查看状态能力，暂时关闭远程控制”。七项动作使用 `S3-A1` 至 `S3-A7`，统一维护在 `content/lab-cases/car-control/v1/scenario-plan.json`。

**已确认情景三最小正确卡片**：最小行动链包含 14 张卡。文件卡为 D32 测试与评估文件、D20 质量报告和 D26 风险登记册；工具与技术卡为漏洞复现与安全验证、综合影响与备选方案分析、CCB 及上线阶段门审查；执行卡为冻结远程控制并创建正式变更、启用功能开关与权限隔离并验证只读能力、更新资料并沟通分阶段发布及修复计划；干系人卡为 DevOps/安全工程师、第三方安全测试负责人、技术负责人、产品负责人/业务分析师和项目发起人。D05 变更日志、D16 项目范围说明书、D22 需求跟踪矩阵和 D29 进度预测是必须查看的场景线索，但不要求拖入最小行动链。

**已确认情景三最小正确连接**：最小闭环包含 22 条有向连接。文件到工具共 5 条：D32/D20 连接漏洞复现与安全验证，D20/D26 连接综合影响与备选方案分析，D26 连接 CCB 及上线阶段门审查。工具到行动共 8 条：漏洞验证连接冻结远程控制和隔离验证只读；影响分析连接三张执行卡；CCB 及阶段门同样连接三张执行卡。行动到干系人共 9 条：冻结远程控制连接安全工程师、技术负责人、产品负责人和项目发起人；隔离验证只读连接安全工程师、第三方安全测试负责人和技术负责人；更新沟通连接产品负责人和项目发起人。卡片正确但连接缺失时仅反馈对应闭环缺口。
